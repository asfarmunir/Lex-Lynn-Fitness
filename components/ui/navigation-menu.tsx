...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "relative z-10 flex w-full bg-red-100 flex-1 items-center justify-center",
      className
    )}
    {...props}
  >
