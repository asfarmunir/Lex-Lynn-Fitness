  ...
  return (
    <div className=" bg-white min-h-[500px] flex max-h-screen overflow-y-auto mb-12 flex-col w-full items-start p-6 justify-start">
      <div className=" w-full flex items-start  justify-between mb-10">
        <div>
          <h2 className=" text-xl lg:text-3xl mb-3">Teams</h2>
          <p className=" text-sm lg:text-base font-sans font-semibold">
            Manage your team members.
          </p>
        </div>
        <button className=" flex text-white px-3 text-sm lg:text-base text-nowrap   py-1.5 gap-2 items-center justify-start bg-primary-50 ">
          <IoMdAdd className="text-base lg:text-xl" />
          Add New Member
        </button>{" "}
      </div>
      <div className="flex w-full  items-center bg-gray-100  px-3 mb-7">
      ...
      <section className=" w-full">
        {changeTab === "active" ? (
          <Table className=" min-w-[900px]">
            ...
            <TableBody>
              <TableRow className=" ">
                ...
                <TableCell className="text-center font-semibold py-5 font-sans">
                  2 Months
                </TableCell>
                <TableCell className="py-5">
                  <p className="py-2.5 font-sans bg-emerald-300/70 text-center">
                    14 hours ago
                  </p>
                </TableCell>

                <TableCell className="text-center py-5 font-sans font-semibold">
                  5
                </TableCell>
          ...
          <Table className=" min-w-[900px]">
            <TableCaption>No Archived Members</TableCaption>
            <TableHeader className=" bg-primary">
              <TableRow>
                <TableHead className=" text-black font-bold w-[300px] text-center  ">
                  Name
